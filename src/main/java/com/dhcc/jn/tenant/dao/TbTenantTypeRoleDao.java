...
public interface TbTenantTypeRoleDao extends BaseDao<TbTenantTypeRole, String> {
     ...
     * @return
     */
    List<TbResourceApplicationType> getUserFunctionalResources(@Param("zhTypeId") String zhTypeId);
     ...
     * @param roleId
     */
    void delRoleResources(@Param("roleId") String roleId,@Param("appTypeCode") String appTypeCode);
     ...
     * @return
     */
    TbTenantTypeRole getByzhTypeIdAndRoleCode(String zhTypeId);
