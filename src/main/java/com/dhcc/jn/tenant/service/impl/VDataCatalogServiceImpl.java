...
public class VDataCatalogServiceImpl implements VDataCatalogService {
    ...
    public void saveUserData(String zhTypeId, String parentIds, String treeData) {
        ...
        if (StringUtils.isEmpty(treeData)) {
            ...
            for (int i = 0; i < parentIdArray.length; i++) {
            	...
            	if(i ==0 && null != parentIdArray[i] && parentIdArray[i].equals("")) {
    ...
    @Override
    @Transactional
    public List<Map<String, Object>> getRoleDataProductResources(String roleId, String zhTypeId, String dataId) {

        return vDataCatalogDao.getRoleDataProductResources(roleId, zhTypeId, dataId);
    }
    ...
    @Override
    public List<VDataCatalog> getRoleDataTree(String zhTypeId) {
        return vDataCatalogDao.getRoleDataTree(zhTypeId);
    }

    @Override
    public List<VDataCatalog> findBySearch(String zhTypeId,String pid) {
        return vDataCatalogDao.findBySearch(zhTypeId,pid);
    }
